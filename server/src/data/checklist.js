...
export const CHECKLIST = {
  ...
  'Rooms – Floor 2': {
    ...
    isRooms: true,
    floors: [
      { num: '201', cat: 'Double Bed' }, { num: '202', cat: 'Premium' },
      { num: '203', cat: 'Premium' }, { num: '204', cat: 'Premium' },
      { num: '205', cat: 'Premium' }, { num: '206', cat: 'Family Premium Double Bed' },
      { num: '207', cat: 'Premium' }, { num: '208', cat: 'Family Premium Double Bed' },
      { num: '209', cat: 'Premium' }, { num: '210', cat: 'Premium' },
      { num: '211', cat: 'Premium' }, { num: '212', cat: 'Premium' },
      { num: '214', cat: 'Premium' }, { num: '215', cat: 'Club', club: true },
      { num: '216', cat: 'Twin Room' }, { num: '217', cat: 'Twin Room' },
    ],
    items: ROOM_ITEMS,
  },
  'Rooms – Floor 3': {
    ...
    isRooms: true,
    floors: [
      { num: '301', cat: 'Premium' }, { num: '302', cat: 'Premium' },
      { num: '303', cat: 'Premium' }, { num: '304', cat: 'Premium' },
      { num: '305', cat: 'Premium' }, { num: '306', cat: 'Family Double Bed' },
      { num: '307', cat: 'Premium' }, { num: '308', cat: 'Family Double Bed' },
      { num: '309', cat: 'Premium' }, { num: '310', cat: 'Premium' },
      { num: '311', cat: 'Premium' }, { num: '312', cat: 'Premium' },
      { num: '314', cat: 'Premium' }, { num: '315', cat: 'Executive Suite' },
      { num: '316', cat: 'Twin Room' },
    ],
    items: ROOM_ITEMS,
  },
  'Rooms – Floor 4': {
    ...
    isRooms: true,
    floors: [
      { num: '401', cat: 'Premium' }, { num: '402', cat: 'Premium' },
      { num: '403', cat: 'Premium' }, { num: '404', cat: 'Premium' },
      { num: '405', cat: 'Premium' }, { num: '406', cat: 'Family Double Bed' },
      { num: '407', cat: 'Premium' }, { num: '408', cat: 'Family Double Bed' },
      { num: '409', cat: 'Premium' }, { num: '410', cat: 'Premium' },
      { num: '411', cat: 'Premium' }, { num: '412', cat: 'Premium' },
      { num: '414', cat: 'Premium' }, { num: '415', cat: 'Club', club: true },
      { num: '416', cat: 'Twin Room' }, { num: '417', cat: 'Twin Room' },
    ],
    items: ROOM_ITEMS,
  },
  'Rooms – Floor 5': {
    ...
    isRooms: true,
    floors: [
      { num: '501', cat: 'Premium' }, { num: '502', cat: 'Premium' },
      { num: '503', cat: 'Premium' }, { num: '504', cat: 'Premium' },
      { num: '505', cat: 'Premium' }, { num: '506', cat: 'Two Double Bed' },
      { num: '507', cat: 'Premium' }, { num: '508', cat: 'Two Double Bed' },
      { num: '509', cat: 'House Keeping' }, { num: '510', cat: 'Premium' },
      { num: '511', cat: 'Premium' }, { num: '512', cat: 'Premium' },
      { num: '514', cat: 'Premium' }, { num: '515', cat: 'Twin Room' },
      { num: '516', cat: 'Club', club: true }, { num: '517', cat: 'Twin Room' },
    ],
    items: ROOM_ITEMS,
  },
  'Rooms – Floor 6 Club': {
    ...
    isRooms: true,
    floors: [
      { num: '601', cat: 'Club', club: true }, { num: '602', cat: 'Club', club: true },
      { num: '603', cat: 'Deluxe Suite' }, { num: '604', cat: 'Club', club: true },
      { num: '605', cat: 'Club', club: true }, { num: '606', cat: 'Executive Suite' },
      { num: '607', cat: 'Executive Suite' }, { num: '608', cat: 'Club', club: true },
      { num: '609', cat: 'Club', club: true }, { num: '610', cat: 'Deluxe Suite' },
      // 616 is not in the latest floor-layout deck; kept to preserve any data
      // already recorded against it.
      { num: '616', cat: 'Club', club: true },
    ],
    items: ROOM_ITEMS,
  },
  'Licenses – Lessor': {
