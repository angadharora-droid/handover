...
export const CHECKLIST = {
  ...
  'Rooms – Floor 2': {
    ...
    floors: [
      ...
      { num: '214', cat: 'Standard' }, { num: '215', cat: 'Premium' }, { num: '216', cat: 'Standard' },
    ],
    items: ROOM_ITEMS,
  },
  'Rooms – Floor 3': {
    ...
    floors: [
      ...
      { num: '314', cat: 'Standard' }, { num: '316', cat: 'Premium' },
    ],
    items: ROOM_ITEMS,
  },
  'Rooms – Floor 4': {
    ...
    floors: [
      ...
      { num: '414', cat: 'Standard' }, { num: '415', cat: 'Premium' }, { num: '416', cat: 'Standard' },
    ],
    items: ROOM_ITEMS,
  },
  'Rooms – Floor 5': {
    ...
    floors: [
      ...
      { num: '514', cat: 'Standard' }, { num: '516', cat: 'Premium' },
    ],
    items: ROOM_ITEMS,
  },
  'Rooms – Floor 6 Club': {
